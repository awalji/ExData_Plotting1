...
lines(Data$Time,Data[,8],col='orangered')

lines(Data$Time,Data[,9],col='blue')

legend("topright",lty=1,box.lwd=1,cex=0.75,col=c(1,"orangered","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))